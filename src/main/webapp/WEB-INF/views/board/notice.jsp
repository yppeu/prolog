	...
	<h1>공지사항(notice)</h1>
 			...
 			<c:choose>
 				<c:when test="${principal.user.username == 'admin_user'}"> <!-- 관리자가 로그인했을 경우, 공지사항 글작성 권한을 주기위해 -->
 					<div align="right"><a href="adminWrite?user_id=${principal.user.username}"><button type="button" class="btn btn-info" id="writeBtn"><img src="../images/pencil.png" width="30"></button></a></div>
				</c:when>
			</c:choose>		
					</table>
					<table align="center">
